...
<body>
		...
		<div class="ct main">
			<div>
				...
				<div class="section_store_details">
					...
					<div id="detailExplanation" class="store_details close3">
						<p class="dsc"></p>
					</div>
					<!-- [D] 토글 상황에 따라 bk_more에 display:none 추가 -->
					<a class="bk_more _open" id="bk_more_open"> <span
						class="bk_more_txt">펼쳐보기</span> <i class="fn fn-down2"></i>
					</a> <a class="bk_more _close" id="bk_more_close"
				...
				<div class="section_info_tab">
					...
					<ul id="detailInfoTab" class="info_tab_lst">
						<li class="item active _detail" id="itemDetail"><a
							class="anchor active"> <span>상세정보</span>
						</a></li>
						<li class="item _path" id="itemPath"><a class="anchor"> <span>오시는길</span>
						</a></li>
					</ul>
					<!-- [D] 상세정보 외 다른 탭 선택 시 detail_area_wrap에 hide 추가 -->
					<div class="detail_area_wrap" id="detailInfo"></div>
					<!-- [D] 오시는길 외 다른 탭 선택 시 detail_location에 hide 추가 -->
					<div class="detail_location hide" id="detailLocation"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="myTemplate" id="itemDetailTemplate">
	...
	<script type="myTemplate" id="itemPathTemplate">
        <div class="box_store_info no_topline">
            <a class="store_location" title="지도웹으로 연결"> <img
                class="store_map img_thumb" alt="map" src= "https://simg.pstatic.net/static.map/image?version=1.1&amp;crs=EPSG:4326&amp;baselayer=bl_vc_bg&amp;exception=xml&amp;scale=2&amp;caller=mw_smart_booking&amp;overlayers=ol_vc_an&amp;center=127.0011948,37.5717079&amp;markers=type,default2,127.0011948,37.5717079&amp;level=11&amp;w=340&amp;h=150">
                <span class="img_border"></span> <span class="btn_map"><i
                    class="spr_book2 ico_mapview"></i></span>
            </a>
            <h3 class="store_name">{{placeDescription}}</h3>
