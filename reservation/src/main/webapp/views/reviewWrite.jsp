		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="/reservations?resrv_email=${sessionScope.email}" class="btn_back" title="이전 화면으로 이동"> <i
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						<form action="/" method="post" id="reviewForm" enctype="multipart/form-data">
							...
							<div>
								<span class="invalid" style="display: none">최소 5자,최대 400자의 글자를 입력 가능합니다.</span>
							</div>
