	...
	<div id="container">
		<c:if test="${empty email}">
			<div class="err">
				...
				<h1 class="tit">
					잘못된 접근입니다.<br /> 리뷰 작성은 로그인 후 이용해주세요.
				</h1>
			</div>
	...
	<div class="ct">
		<div class="ct_wrap">
			<div class="top_title review_header">
				<a href="/reservations?resrv_email=${sessionScope.email}"
			...
			<div class="write_act">
				...
				<div class="review_rating rating_point">
					<div class="rating">
						...
						<input type="checkbox" name="rating2" value="1" class="rating_rdo"
							title="1점"> <span class="span"></span> <input
							type="checkbox" name="rating3" value="2" class="rating_rdo"
							title="2점"> <span class="span"></span> <input
							type="checkbox" name="rating4" value="3" class="rating_rdo"
							title="3점"> <span class="span"></span> <input
							type="checkbox" name="rating5" value="4" class="rating_rdo"
							title="4점"> <span class="span"></span> <input
							type="checkbox" name="rating6" value="5" class="rating_rdo"
							title="5점"> <span class="span"></span>
				...
				<div class="review_write_footer">
					<form action="/" method="post" id="reviewForm"
						...
						<label class="btn_upload" for="reviewImageFileOpenInput">
							...
							id="reviewImageFileOpenInput" name="file" accept="image/*"
							multiple>
						...
						<div>
							<span class="invalid" style="display: none">최소 5자,최대 400자의
								글자를 입력 가능합니다.</span>
						</div>

						<input type="hidden" id="form_comment" name="form_comment"
							value=""> <input type="hidden" id="form_productId"
							name="form_productId" value=""> <input type="hidden"
							id="form_score" name="form_score" value=""> <input
							type="hidden" id="form_email" name="form_email"
